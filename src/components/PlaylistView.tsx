...
import { Play, Pause, Trash2, Download, Music, MoreHorizontal } from "lucide-react";
      ...
      <div className="p-6 pb-4">
        ...
        >
          <div className="relative flex-shrink-0 group">
            <div className="flex h-44 w-44 items-center justify-center rounded-2xl bg-gradient-to-br from-primary/30 to-primary/5 overflow-hidden shadow-2xl">
            ...
            {playlist.tracks.length > 0 && (
              <button
                ...
                className="absolute bottom-3 right-3 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-xl glow-primary opacity-0 group-hover:opacity-100 transition-all duration-300 hover:scale-105"
              >
          ...
          <div className="min-w-0 flex-1">
            ...
            <h1 className="text-4xl font-bold text-foreground truncate">{playlist.name}</h1>
        ...
        >
          <Button
            ...
            size="lg"
            className="rounded-full gap-2 px-8 glow-primary-sm hover:glow-primary transition-all"
          >
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className="text-muted-foreground hover:text-destructive hover:bg-destructive/10 ml-auto rounded-xl"
          >
            ...
            {playlist.tracks.map((track, i) => {
              ...
              return (
                ...
                >
                  ...
                  <img src={track.thumbnail} alt="" className="h-12 w-12 rounded-lg object-cover flex-shrink-0 shadow-lg" />
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      onClick={e => { e.stopPropagation(); handleDownloadSingle(track); }}
